...
class MultimodalGenerativeCVAE(object):
    ...
    def predict(self,
        ...
        # our_sampled_future contains information about the future state of the system
        # change the return to self.latent.p_dist.probs, our_sampled_future; 
        # where self.latent.p_dist.probs is the mode probability (i.e. probability of each waypoint)
