...
def main():
    ...
    model_dir = os.path.join(args.log_dir, 'robot2')
    ...
    for timestep in range(init_timestep + 1, eval_scene.timesteps):
        ...
        dists, preds = trajectron.incremental_forward(input_dict,
                                                      maps,
                                                      prediction_horizon=6, #how long into the future do you want to predict?
                                                      num_samples=1, #how many different trajectories do you want?
